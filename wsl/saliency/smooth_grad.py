...
from wsl.saliency.misc_functions import (get_example_params,
                            convert_to_grayscale,
                            save_gradient_images)
from wsl.saliency.vanilla_backprop import VanillaBackprop
...
def generate_smooth_grad(Backprop, prep_img, target_class, param_n, param_sigma_multiplier):
    ...
    print('sigma', torch.max(prep_img), ' ',param_sigma_multiplier, ' ',sigma)
